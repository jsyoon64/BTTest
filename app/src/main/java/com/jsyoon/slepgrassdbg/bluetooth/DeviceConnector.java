...
package com.jsyoon.slepgrassdbg.bluetooth;
...
public class DeviceConnector {
    ...
    public synchronized void connected(BluetoothSocket socket) {
        ...
        Message msg = mHandler.obtainMessage(Const.MESSAGE_DEVICE_NAME, deviceName);
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    if (readed.contains("\n")) {
                        mHandler.obtainMessage(Const.MESSAGE_READ, bytes, -1, readMessage.toString()).sendToTarget();
        ...
        public void writeData(byte[] chunk) {
            ...
            try {
                ...
                mHandler.obtainMessage(Const.MESSAGE_WRITE, -1, -1, chunk).sendToTarget();
            } catch (IOException e) {
        ...
        public void write(byte command) {
            ...
            try {
                ...
                // Share the sent message back to the UI Activity
                mHandler.obtainMessage(Const.MESSAGE_WRITE, -1, -1, buffer).sendToTarget();
            } catch (IOException e) {
                if (D) Log.e(TAG, "Exception during write", e);
            }
        }
